...
$subjectcode=$_POST['dept']; 
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,Dept_id) VALUES(:subjectname,:subjectcode,:dept)";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectcode',$subjectcode,PDO::PARAM_STR);
$query->bindParam(':dept',$subjectcode,PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Subject Code" required="required">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Department" required="required">
                                                        </div>
                                                    </div>
