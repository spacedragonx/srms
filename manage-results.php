                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblclasses.id,tblclasses.Department,tblstudents.Status,tblsubjects.SubjectName,tblsubjects.SubjectCode from tblresult,tblstudents,tblsubjects join tblresult on tblstudents.StudentId=tblresult.StudentId  join tblclasses on tblclasses.id=tblresult.ClassId";
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->ClassId);?>(<?php echo htmlentities($result->Department);?>)</td>
