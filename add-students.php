...
<div class="form-group">
    <label for="Int" class="col-sm-2 control-label">Contact No</label>
    <div class="col-sm-10">
        <input type="Int"  name="ContactNo" class="form-control" id="Int">
    </div>
</div>

<div class="form-group">
    <label for="text" class="col-sm-2 control-label">Department</label>
    <div class="col-sm-10">
        <input type="Text"  name="Deoartment" class="form-control" id="text">
</div>
</div>
